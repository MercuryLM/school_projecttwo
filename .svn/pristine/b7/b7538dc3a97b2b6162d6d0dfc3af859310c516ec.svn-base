			     ...
			     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
					...
					<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					    ...
					    <td width="40%" bgcolor="#FFFFFF" align="left">
					        <input type="text" name="ctname" value="<s:property value="model.ctname"/>" id="categoryThirdAction_save_do_logonName" size="20"/>
					    </td>
					    <td width="10%" bgColor="#FFFFFF" align="left">
						所属的二级分类：
						</td>
						<td width="40%" bgColor="#FFFFFF" >
							<select name="csid" style="width:60%">
								<s:iterator var="cs" value="csList">
									<option value="<s:property value="#cs.csid"/>" <s:if test="#cs.csid==model.csid">selected</s:if>><s:property value="#cs.csname"/></option>
								</s:iterator>
							</select>
						</td>
					</tr>
